...
* 특징
    ...
    * 멀티조인트의 어떤 CF. MJ CF라고 하는 모델링과 urdf라고 하는 모델링을 지원. 여러 가지 확장 urdf를 활용해서 시뮬레이션을 구성할 수 있음
    * 강화학습에 최적화. 물리 시뮬레이션에 대한 속도나 정확성 좋음
* 한계점
    * 단순한 렌더링. 현실적인 실사에 가까운 거나 복잡하고 화려한 렌더링에 적합하지 않음
